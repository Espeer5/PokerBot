...
from message_types.CardMessage import CardMessage
...
class CardDetectorNode(Node):
    ...
    def __init__(self, name):
        ...
        self.locpub = self.create_publisher(CardMessage, '/card_messages',     3)
    ...
    def process(self, msg):
        ...
        for contour in card_contours:
            ...
            frame = draw_results(frame, rank, suit, (x, y))
            ...
            if world_loc is not None:
                ...
                card_point = Point(x=float(world_loc[0]), y=float(world_loc[1]), z=float(0.01))
                card_message = CardMessage(rank, suit, card_point)

                self.locpub.publish(card_message)
