...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/card_features', glob('detectors/references/BoxCardDescriptors.json')),
        ('share/' + package_name + '/card_images', glob('detectors/references/card_images/*')),
