...
PLAYERS = [Player([(-0.555, 0.37), (-0.44, 0.22)], [(-0.555, 0.38), (-0.44, 0.53)]),
           Player([(-0.36, 0.63), (-0.21, 0.74)], [(-0.20, 0.63), (-0.05, 0.74)]),
           Player([(0.02, 0.63), (0.17, 0.74)], [(0.18, 0.63), (0.35, 0.74)]),
           Player([(0.44, 0.37), (0.56, 0.52)], [(0.44, 0.21), (0.56, 0.36)]),
           Player([(-0.395, 0.045), (-0.235, 0.16)], [(0.235, 0.045), (0.395, 0.16)])]
